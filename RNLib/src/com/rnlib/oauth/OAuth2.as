 ...
 *
 * Based on Adobe solution with many improvments.
 */
package com.rnlib.oauth
{
	...
	[Event(name="authSuccess", type="com.rnlib.oauth.OAuth2Event")]
	[Event(name="authError", type="com.rnlib.oauth.OAuth2Event")]
	[Event(name="getAccessTokenSuccess", type="com.rnlib.oauth.OAuth2Event")]
	[Event(name="getAccessTokenError", type="com.rnlib.oauth.OAuth2Event")]
	...
	public class OAuth2 extends EventDispatcher
	{
		...
		private function onWebChange(ev:LocationChangeEvent):void
		{
			...
			if (!code)
			{
				ED.now(new OAuth2Event(OAuth2Event.AUTH_ERROR), this);
				return;
			}

			ED.now(new OAuth2Event(OAuth2Event.AUTH_SUCCESS), this);
		...
		private function onLoaderError(ev:Event):void
		{
			...
			ED.now(new OAuth2Event(OAuth2Event.GET_ACCESS_TOKEN_ERROR), this);
		}
		...
		private function onLoaderComplete(ev:Event):void
		{
			...
			ED.now(new OAuth2Event(OAuth2Event.GET_ACCESS_TOKEN_SUCCESS, response), this);
		}
