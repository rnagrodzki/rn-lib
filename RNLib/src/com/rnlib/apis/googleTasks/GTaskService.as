...
package com.rnlib.apis.googleTasks
{
	...
	public class GTaskService extends AbstractApiService
	{
		...
		protected function onLoad(ev:Event):void
		{
			...
			ED.now(new GTaskEvent(GTaskEvent.ALL_TASKS_FROM_LIST_LOADED, _currentList), this);
		}
		...
		{
			unregisterLoader(ev);
			ED.now(new GTaskEvent(GTaskEvent.ALL_TASKS_FROM_LIST_LOAD_ERROR), this);
		}
		...
		protected function onLoadTask(ev:Event):void
		{
			...
			ED.now(new GTaskEvent(GTaskEvent.TASK_LOADED, _currentTask), this);
		}
		...
		{
			unregisterLoader(ev);
			ED.now(new GTaskEvent(GTaskEvent.TASK_LOAD_ERROR), this);
		}
