...
import rnlib.net.plugins.examples.FileReferencePlugin;
import rnlib.net.plugins.examples.FileReferencePluginVO;
import rnlib.net.service.RemoteService;
import rnlib.net.service.Request;
import rnlib.net.service.helpers.MockResponseVO;

/**
 * @exampleText Advanced usage of RemoteAMFService. In this example we will login user, upload files in collections on
 *         server and logout after finish.
 */
