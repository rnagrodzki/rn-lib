...
package mocks
{
	...
	public class ConnectionMock extends EventDispatcher implements IConnection
	{
		/**
		...
		public function connect(uri:String):void
		{
			_connected = true;
			if (_redispatcher)
				_redispatcher.dispatchEvent(new ServiceEvent(ServiceEvent.CONNECTED));
		}
		...
		public function close():void
		{
			_connected = false;
			if (_redispatcher)
				_redispatcher.dispatchEvent(new ServiceEvent(ServiceEvent.DISCONNECTED));
		}
		...
		public function call(command:String, result:Function = null, fault:Function = null, ...args):void
		{
			...
			setTimeout(callResult ? result : fault, 1, dataToPass);
			dataToPass = null;
		}
